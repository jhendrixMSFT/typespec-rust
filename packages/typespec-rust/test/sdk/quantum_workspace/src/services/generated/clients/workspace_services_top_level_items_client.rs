...
use crate::{
    models::PagedItemDetails,
    services::generated::models::WorkspaceServicesTopLevelItemsClientListv2Options,
};
use azure_core::{
...
#[tracing::client]
pub struct WorkspaceServicesTopLevelItemsClient {
    pub(crate) api_version: String,
    pub(crate) endpoint: Url,
    pub(crate) pipeline: Pipeline,
}

impl WorkspaceServicesTopLevelItemsClient {
    ...
    #[tracing::function("Quantum.Workspace.Services.TopLevelItems.listv2")]
    pub fn listv2(
        &self,
        subscription_id: &str,
        resource_group_name: &str,
        workspace_name: &str,
        options: Option<WorkspaceServicesTopLevelItemsClientListv2Options<'_>>,
    ) -> Result<Pager<PagedItemDetails>> {
        ...
        let mut path = String::from("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Quantum/workspaces/{workspaceName}/topLevelItems");
            ...
            move |next_link: PagerState, pager_options| {
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        let res: PagedItemDetails = json::from_json(&body)?;
