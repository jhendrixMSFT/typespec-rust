...
use crate::{
    models::PagedProviderStatus,
    services::generated::models::WorkspaceServicesProvidersClientListOptions,
};
use azure_core::{
...
#[tracing::client]
pub struct WorkspaceServicesProvidersClient {
    pub(crate) api_version: String,
    pub(crate) endpoint: Url,
    pub(crate) pipeline: Pipeline,
}

impl WorkspaceServicesProvidersClient {
    ...
    #[tracing::function("Quantum.Workspace.Services.Providers.list")]
    pub fn list(
        &self,
        subscription_id: &str,
        resource_group_name: &str,
        workspace_name: &str,
        options: Option<WorkspaceServicesProvidersClientListOptions<'_>>,
    ) -> Result<Pager<PagedProviderStatus>> {
        ...
        let mut path = String::from("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Quantum/workspaces/{workspaceName}/providerStatus");
            ...
            move |next_link: PagerState, pager_options| {
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        let res: PagedProviderStatus = json::from_json(&body)?;
